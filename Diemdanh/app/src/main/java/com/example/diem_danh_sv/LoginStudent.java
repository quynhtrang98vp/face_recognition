...
import com.example.diem_danh_sv.fragment.fragment_thoi_khoa_bieu_sv;
import com.example.diem_danh_sv.fragment.fragment_thong_ke_sv;
import com.example.diem_danh_sv.fragment.fragment_tro_giup;

public class LoginStudent extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
   ...
   */
    private void receive(){
        ...
        account = new Account();
        account = (Account) intent.getSerializableExtra("login_student");
    }
    ...
    */
    ...
    public boolean onNavigationItemSelected(MenuItem item){
        ...
        }else if(id == R.id.thoi_khoa_bieu_sv){

            receive();
            Bundle bundle = new Bundle();
            bundle.putString("email_id", account.getToEmail_id ());
            fragment = new fragment_thoi_khoa_bieu_sv ();
            ft.replace(R.id.frag_tai_khoan, fragment);
            ft.commit();
            fragment.setArguments(bundle);

        }else if(id == R.id.thong_ke_sv){
            receive();
            Bundle bundle = new Bundle();
            bundle.putString("email_id", account.getToEmail_id ());
            fragment = new fragment_thong_ke_sv ();
            ft.replace(R.id.frag_tai_khoan, fragment);
            ft.commit();
            fragment.setArguments(bundle);

        }else if(id == R.id.tro_giup_sv){
            // tao fragment moi
